...
export const Projects: CollectionConfig = {
  ...
  admin: {
    group: 'Listings',
    useAsTitle: 'name',
    defaultColumns: ['projectId', 'name', 'developer', 'status', 'updatedAt'],
  },
  ...
  fields: [
    ...
    // projectId/mediaFolder are system-managed (see their own
    ...
    // (e.g. `projectDetails.projectType`, not
    // `projectDetails.tabName.projectType`). This means
    // payload-types.ts, mapProject.ts, and every public
